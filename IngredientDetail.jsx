  ...
  const fetchWeather = async () => {
    try {
      ...
      const forecastResponse = await fetch(
        `https://api.openweathermap.org/data/2.5/forecast/daily?q=${selectedCity.city},IN&appid=${API_KEY}&units=metric&cnt=10`
      );
                ...
                <div className="bg-gray-50 rounded-xl p-6">
                  ...
                  {weather && (
                    ...
                    >
                      ...
                      {forecast && (
                        <div className="mt-6">
                          <h3 className="font-semibold text-lg mb-4">10-Day Forecast</h3>
